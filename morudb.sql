...
DROP TABLE IF EXISTS `COMMENT_BASE_TB`;
DROP TABLE IF EXISTS `BOARD_BASE_TB`;
...
CREATE TABLE `BOARD_BASE_TB` (									# 공지게시판
...
ALTER TABLE `BOARD_BASE_TB` ADD CONSTRAINT `BOARD_BASE_BO_NUM_PK` PRIMARY KEY (`BO_NUM`);
ALTER TABLE `BOARD_BASE_TB` MODIFY `BO_NUM` INT NOT NULL AUTO_INCREMENT;
ALTER TABLE `BOARD_BASE_TB` ADD CONSTRAINT `BOARD_BASE_UI_ID_FK` FOREIGN KEY (`UI_ID`) REFERENCES USER_INFO_TB(UI_ID);


CREATE TABLE `COMMENT_BASE_TB` (									# 공지게시판 댓글
...
ALTER TABLE `COMMENT_BASE_TB` ADD CONSTRAINT `COMMENT_BASE_CO_NUM_PK` PRIMARY KEY (`CO_NUM`);
ALTER TABLE `COMMENT_BASE_TB` MODIFY `CO_NUM` INT NOT NULL AUTO_INCREMENT;
ALTER TABLE `COMMENT_BASE_TB` ADD CONSTRAINT `COMMENT_BASE_BO_NUM_FK` FOREIGN KEY (`BO_NUM`) REFERENCES BOARD_BASE_TB(BO_NUM);
ALTER TABLE `COMMENT_BASE_TB` ADD CONSTRAINT `COMMENT_BASE_UI_ID_FK` FOREIGN KEY (`UI_ID`) REFERENCES USER_INFO_TB(UI_ID);
...
ALTER TABLE `BOARD_FILE_TB` ADD CONSTRAINT `BOARD_FILE_BO_NUM_FK` FOREIGN KEY (`BO_NUM`) REFERENCES BOARD_BASE_TB(BO_NUM);
